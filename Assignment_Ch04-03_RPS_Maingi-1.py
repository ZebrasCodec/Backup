...
def reasoning(rk,pp,sc):
    if user or comp in rk and comp or user in sc:
        return "Rock crushes Scissors"
    elif user or comp in pp and comp or user in rk:
        return "Paper beats Rock (somehow)"
    elif user or comp in sc and comp or user in pp:
